...
{
    public partial class Admin_Notification : Form
    {
        public Admin_Notification()
        {
            InitializeComponent();
            this.FormClosed += Admin_Notification_FormClosed;
        }
        private void Admin_Notification_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void Admin_Notification_Load(object sender, EventArgs e)
        {
